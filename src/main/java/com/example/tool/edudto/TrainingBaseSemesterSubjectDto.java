...
public class TrainingBaseSemesterSubjectDto {
	...
	public TrainingBaseSemesterSubjectDto(TrainingBaseSemesterSubject t) {
		if(t!=null) {
			this.numberCourseSubject = t.getNumberCourseSubject();
			this.id = t.getId();
			if(t.getTrainingBase()!=null) 
				this.trainingBase = new TrainingBaseDto(t.getTrainingBase());
			if(t.getSemesterSubject()!=null)
				this.semesterSubject = new SemesterSubjectDto(t.getSemesterSubject());
		}
	}
}
